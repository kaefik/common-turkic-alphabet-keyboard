...
Проект раскладки для татарского языка будет содержит так называемые практичные раскладки которые добавляют в основные стандартные раскладки клавиатур возможность использования специфичных для татарского языка символов.
